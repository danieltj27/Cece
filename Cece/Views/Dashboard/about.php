		...
		<div class="grid">
			...
			<div class="row">
				...
				<div class="col col--100">
					...
					<p>Cece is free open source software and licensed under MIT.</p>

					<p>The following people have made significant contributions to the Cece project.</p>

					<div class="about__contribs">
					...
					<p>Special thanks to the following open source projects and resources.</p>
