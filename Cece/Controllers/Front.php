...
class Front extends Controller {
	...
	public function __construct() {
		...
		do_event( 'front/controller/before', array( 'class' => $this ) );
		...
		do_event( 'front/controller/after', array( 'class' => $this ) );
	...
	public static function index() {
		...
		return self::view( theme_template_path( 'index.php' ), array( 'title' => 'Home', 'posts' => $posts ), true );
	...
	public static function view_tag( $params ) {
		...
		return self::view( theme_template_path( 'tag.php' ), array( 'title' => $tag->tag_name, 'tag' => $tag, 'posts' => $posts ), true );
