...
class System extends Controller {
	 ...
	 * @var string
	 */
	public static $path = CECEAPP . 'Views/System/';
	...
	public static function install_setup() {
		...
		if ( $database->is_connected ) {
			...
			return self::view( self::$path . 'install_register.php', array( 'title' => 'Install Cece' ), true );

		} else {

			return self::view( self::$path . 'install_database.php', array( 'title' => 'Install Cece' ), true );
...
define( 'DB_PREFIX', '" . $_POST[ 'prefix' ] . "' );" . PHP_EOL;
		...
		$file = fopen( CECEPATH . 'config.php', 'wb' );
