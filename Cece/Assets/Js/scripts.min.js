...
$(document).ready(function() {
	...
	$('body').on('keypress', '.button--toggle', function(e) {
		e.preventDefault();
		if ( 13 == e.which ) {
			var toggleTarget = $(this).attr('data-toggle-target');
			var ariaExpanded = $(this).attr('aria-expanded');
	 ...
	 * Post status buttons.
	 */
	$('.js-btn-update-post').on('click', function(e) {
		e.preventDefault();
		var postField = $(this).attr('data-post-field');
		var postValue = $(this).attr('data-post-value');
		$('#' + postField).val( postValue );
